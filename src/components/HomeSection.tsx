      ...
      <div className="max-w-4xl mx-auto px-4 text-center z-10">
        <div className="flex flex-col items-center">
          ...
          >
            ...
            <div className={`absolute -inset-4 rounded-full border border-dashed animate-spin ${isDarkMode ? 'border-orange-500/30' : 'border-orange-600/20'
              }`} style={{ animationDuration: '40s' }} />

            <div className={`absolute -inset-2 rounded-full border border-dashed animate-spin ${isDarkMode ? 'border-amber-500/30' : 'border-amber-600/20'
            ...
            <motion.div
              className={`absolute -bottom-3 -right-3 px-3 py-1 rounded-full text-xs font-mono font-bold border shadow-lg flex items-center gap-1.5 ${isDarkMode
            ...
            <motion.div
              className={`absolute -top-3 -left-3 p-2 rounded-xl text-xs border shadow-lg ${isDarkMode
          ...
          <motion.div
            ...
            className={`mb-4 px-4 py-1.5 rounded-full font-mono text-xs tracking-widest uppercase border inline-flex items-center gap-2 ${isDarkMode
          ...
          <motion.h1
            id="user-fullname"
            className={`text-4xl sm:text-6xl font-bold tracking-tight mb-4 ${isDarkMode
              ? 'text-white'
              : 'text-slate-900'
              }`}
          ...
          >
            <span className={`bg-clip-text text-transparent bg-gradient-to-r ${isDarkMode
          ...
          >
            <p className={`text-lg sm:text-2xl font-mono tracking-wide ${isDarkMode ? 'text-slate-300' : 'text-slate-600'
              }`}>
              Kasbi:{' '}
              <span className={`font-bold typing-caret pb-1 border-b-2 ${isDarkMode
          ...
          <motion.p
            id="short-intro"
            className={`max-w-xl text-sm sm:text-base mb-10 leading-relaxed ${isDarkMode ? 'text-slate-400' : 'text-slate-600'
              }`}
            initial={{ opacity: 0, y: 15 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <motion.button
              ...
              className={`w-full sm:w-auto px-8 py-4 rounded-2xl font-bold cursor-pointer shadow-lg flex items-center justify-center gap-2 transition-all group ${isDarkMode
            ...
            <motion.a
              ...
              className={`w-full sm:w-auto px-8 py-4 rounded-2xl font-semibold border flex items-center justify-center gap-2 transition-all ${isDarkMode
          ...
          >
            <span className={`text-[10px] font-mono uppercase tracking-widest ${isDarkMode ? 'text-slate-400' : 'text-slate-500'
              }`}>
              Pastga aylantiring
            </span>
            <div className={`w-1 h-8 rounded-full ${isDarkMode ? 'bg-gradient-to-b from-orange-500 to-transparent' : 'bg-gradient-to-b from-orange-600 to-transparent'
              }`} />
          </motion.div>
